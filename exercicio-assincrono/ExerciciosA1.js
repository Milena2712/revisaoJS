...
const { name } = company;
const colors = [company.products.shirts.colors, company.products.socks.colors];
console.log(name);
console.log(colors);
...
let raiz = numbers.map((number) => Math.sqrt(number));
